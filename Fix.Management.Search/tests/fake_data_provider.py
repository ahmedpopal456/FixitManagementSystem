...
def get_mock_sql_data():
    ...
    data = {'Id':[
            ...
            'Skills':[
                "Masonry, Concrete, Demolition, Heavy Equipment",
                "Masonry, Concrete, Demolition, Heavy Equipment",
                "Masonry, Concrete, Demolition, Heavy Equipment",
                "Masonry, Concrete, Demolition, Heavy Equipment"
            ],
            ...
            'SectionField':[
                "Wood;Slate, Tile;Stone;Marble, Pull Down;Pul Out;1-Handle;2-Handle;Tochless & Touch On Faucets;Bar;Voice Control",
                "Wood;Slate, Tile;Stone;Marble, Pull Down;Pul Out;1-Handle;2-Handle;Tochless & Touch On Faucets;Bar;Voice Control",
                "Wood;Slate, Tile;Stone;Marble, Pull Down;Pul Out;1-Handle;2-Handle;Tochless & Touch On Faucets;Bar;Voice Control",
                "Wood;Slate, Tile;Stone;Marble, Pull Down;Pul Out;1-Handle;2-Handle;Tochless & Touch On Faucets;Bar;Voice Control",
            ],
